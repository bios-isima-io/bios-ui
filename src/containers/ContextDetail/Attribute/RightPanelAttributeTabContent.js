...
import { updateContextDetail } from 'containers/ContextDetail/actions';
  ...
  const rightPanels = [
    {
      component: (
        <BasicProperties
          ...
          contextDetailCopy={contextDetailCopy}
...
const mapStateToProps = (state) => {
  const { contextDetail, contextDetailCopy } = state.contextDetail;
  ...
  return {
    ...
    contextDetailCopy,
    importFlowSpecsCopy,
    tags: ContextConfig?.tags ? ContextConfig.tags : {},
  };
};
