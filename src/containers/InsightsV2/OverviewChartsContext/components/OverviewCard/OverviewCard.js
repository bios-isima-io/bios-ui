...
import { insightsGridActions } from 'containers/InsightsV2/InsightGridContext/reducers';
  ...
  return (
    <div className="insight-overview-container">
      ...
      <div className="overview-chart">
        <OverviewChart plotData={plotData} />
      </div>
...
const mapStateToProps = (state) => {
  const { gridData } = state?.insights?.insightsContextGrid;
