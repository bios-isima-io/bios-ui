...
import { reportActions } from 'containers/ReportV3/reducers';

const ButtonGroup = Button.Group;

const { setActiveReportIndex } = reportActions;

function ReportSelector({ activeReportIndex, setActiveReportIndex }) {
  return (
    <div>
      <ButtonGroup style={{ background: 'grey' }}>
        <ButtonWrapper
          onClick={() => setActiveReportIndex(0)}
          type={activeReportIndex === 0 ? 'primary' : 'secondary'}
        >
          Report 1
        </ButtonWrapper>
        <ButtonWrapper
          onClick={() => setActiveReportIndex(1)}
          type={activeReportIndex === 1 ? 'primary' : 'secondary'}
        >
          Report 2
        </ButtonWrapper>
      </ButtonGroup>
...
ReportSelector.propTypes = {
  ...
  setActiveReportIndex: PropTypes.func,
};
