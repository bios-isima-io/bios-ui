...
function FlowListAttributeRightPanel({
  selectedAttribute,
...
FlowListAttributeRightPanel.propTypes = {
...
export default connect(null, mapDispatchToProps)(FlowListAttributeRightPanel);
