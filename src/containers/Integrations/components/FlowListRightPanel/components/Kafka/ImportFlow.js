...
function ImportFlow({
  ...
  let { topic, groupId, clientId, payloadType, kwArgs } = sourceDataSpec;
  ...
  return (
    <div className={css(styles.rightPanelSectionContainer)}>
      <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubSectionCol1)}>Topic</div>
        <div>
          <Input
            hideSuffix={true}
            placeholder=""
            onChange={(event) => updateSourceData('topic', event.target.value)}
            value={topic}
          ></Input>
        </div>
      </div>
      ...
      <div className={css(styles.rPanelSubSectionRow)}>
        ...
        <div>
          <Input
            ...
            placeholder=""
            onChange={(event) =>
              updateSourceData('clientId', event.target.value)
            }
            value={clientId}
          ></Input>
        </div>
      ...
      <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubSectionCol1)}>Group Id</div>
        <div>
          <Input
            hideSuffix={true}
            placeholder=""
            onChange={(event) =>
              updateSourceData('groupId', event.target.value)
            }
            value={groupId}
          ></Input>
        </div>
