...
function ImportFlow({ setSourceDataSpec, sourceDataSpec, sourceType }) {
  const { tableName, cdcOperationTypes, columnName } = sourceDataSpec;
  ...
  return (
    <div className={`add-flow-mysql ${css(styles.rightPanelSectionContainer)}`}>
      <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubSectionCol1)}>Table Name</div>
        <div>
          <Input
            ...
            placeholder=""
            onChange={(event) =>
              updateSourceData('tableName', event.target.value)
            }
          ></Input>
        </div>
      </div>
          ...
          <div>
            <MultiSelect
              ...
              onSelectedChanged={(selected) =>
                updateSourceData('cdcOperationTypes', selected)
              }
              onDropdownToggle={() => {}}
            />
          </div>
        ...
        <div className={css(styles.rPanelSubSectionRow)}>
          ...
          <div>
            <Input
              ...
              onChange={(event) => {
                updateSourceData('columnName', event.target.value);
              }}
              value={columnName}
            />
          </div>
