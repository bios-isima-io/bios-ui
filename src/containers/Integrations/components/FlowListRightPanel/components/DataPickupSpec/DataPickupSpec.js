...
function DataPickupSpec({ setDataPickupSpec, dataPickupSpec, flowMapping }) {
  // const [attributeSearchPath, setAttributeSearchPath] = useState();
  const { attributeSearchPath } = dataPickupSpec;
...
DataPickupSpec.propTypes = {
  setDataPickupSpec: PropTypes.func,
  dataPickupSpec: PropTypes.object,
};

export default connect(mapStateToProps, mapDispatchToProps)(DataPickupSpec);
