...
import { KeyValPair } from 'containers/components/KeyValPair';
...
function ImportFlow({
  ...
  const { payloadType, subPath, queryParams, headers } = sourceDataSpec;
  ...
  return (
    <div className={css(styles.rightPanelSectionContainer)}>
      <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubSectionCol1)}>Subpath</div>
        <div>
          <Input
            value={subPath === undefined ? '' : subPath}
            hideSuffix={true}
            placeholder=""
            onChange={(event) =>
              updateSourceData('subPath', event.target.value)
            }
          ></Input>
        </div>
      </div>
      ...
      <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubHeader)}>Query Parameters</div>
      </div>
      <div>
        <KeyValPair
          updateData={updateSourceData}
          ogObject={queryParams ? queryParams : {}}
          ogObjectKey="queryParams"
          placeholderKey="key"
      ...
      {/* <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubHeader)}>Body params</div>
      </div>
      <div>
        <KeyValPair
          updateData={updateSourceData}
          ogObject={bodyParams ? bodyParams : {}}
          ogObjectKey="bodyParams"
          placeholderKey="key"
          placeholderValue="value"
        />
      </div> */}
      ...
      <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubHeader)}>Headers</div>
      </div>
      <div>
        <KeyValPair
          updateData={updateSourceData}
          ogObject={headers ? headers : {}}
          ogObjectKey="headers"
          placeholderKey="key"
          placeholderValue="value"
        />
