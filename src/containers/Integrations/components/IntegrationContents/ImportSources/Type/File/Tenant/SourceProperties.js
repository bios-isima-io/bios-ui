...
function SourceProperties({ setFileData, fileLocation, pollingInterval }) {
  return (
    <div>
      <div className={css(styles.rPanelSubSectionRow)}>
        <div className={css(styles.rPanelSubSectionCol1)}>File Location</div>
        <div>
          <Input
            hideSuffix={true}
            placeholder="/home/biosrepos"
            onChange={(event) =>
              setFileData('fileLocation', event.target.value)
            }
            value={fileLocation}
          ></Input>
        </div>
      ...
      <div className={css(styles.rPanelSubSectionRow)}>
        ...
        <div>
          <Input
            ...
            onChange={(event) =>
              setFileData('pollingInterval', event.target.value)
            }
          ></Input>
        </div>
      </div>
