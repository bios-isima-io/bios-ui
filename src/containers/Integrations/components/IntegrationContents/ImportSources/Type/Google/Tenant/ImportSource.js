...
const { setGoogleIntegration } = googleIntegrationActions;
...
function ImportSource({
  ...
  const setGoogleIntegrationData = (key, value) => {
    setGoogleIntegration({ [key]: value });
  };
        ...
        component: (
          <div className={css(styles.collapsableDiv)}>
            <SourceProperties
              ...
              setGoogleIntegrationData={setGoogleIntegrationData}
            />
          </div>
        ),
