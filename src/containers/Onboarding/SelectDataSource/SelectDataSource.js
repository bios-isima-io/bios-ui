...
import { integrationOnboardingActions } from '../ImportSources/reducers';
import { customSwitchOptions } from './constant';
import styles from './styles';

const { userClicks } = ipxl;
const { setEntityListing } = entityListingActions;
const { resetOnboardingIntegration } = integrationOnboardingActions;
    ...
    <div className={css(styles.wrapper)}>
      ...
      <div className={css(styles.contentWrapper)}>
        ...
        <CustomSwitch
          ...
          selected={selectedEntitySource}
          onChange={(value) => {
            if (selectedEntitySource !== value) {
              resetOnboardingIntegration();
            }
            setEntityListing({
              selectedEntitySource: value,
            });
          }}
        />
        <Actions
          ...
          onNextClick={() => {
            ...
            userClicks({
              ...
              eventLabel: `Selected ${selectedEntitySource}`,
              rightSection: 'None',
              mainSection: 'onboardingSelectDataSource',
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectDataSource);
