...
function EmptyEntityListing({ setStep, selectedEntitySource }) {
  return (
    <div className={css(onboardingStyles.wrapperContainer)}>
      ...
      <div className={css(onboardingStyles.header)}>
        <div className={css(onboardingStyles.headerItem)}>
          {selectedEntitySource === 'mysql' ? 'MySQL' : 'Kafka'}
        </div>
      </div>
      <div className={css(onboardingStyles.header)}>
      ...
      <div className={css(styles.contentWrapper)}>
        <img
          ...
          src={searchImage}
          alt="0 Entities Identified"
        />
        <div>Sorry we couldn’t find any entities</div>
        <Actions
...
export default connect(mapStateToProps, null)(EmptyEntityListing);
