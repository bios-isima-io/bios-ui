 ...
 * of your licenses.
 */
var isimaEslUrl = 'https://bios.isima.io';

(function isimaLoginUI(url) {
  ...
  function signin() {
    ...
    if (email === '' || password === '') {
      signinFailure('Error! Please enter valid credentials');
      return;
    }
    const credentials = {
      email,
  ...
  function signup() {
    ...
    if (email === '') {
      signupFailure('Error! Please enter a valid business email');
      return;
    }
  ...
  function callSignup(credential) {
    /* eslint-disable */
    axios
      .post(`${url}/bios/v1/signup/initiate`, credential)
      .then(() => {
        signupSuccess();
      })
      .catch((error) => {
  ...
  function callSignin(credentials) {
    /* eslint-disable */
    axios
      .post(`${url}/bios/v1/auth/login`, credentials, {
      ...
      .then(
        ...
        () => {
          signinFailure('Sorry! Isima could not find your credentials');
        },
      );
  }
  ...
  function callForgotPassword(email) {
    let message = { email };
    /* eslint-disable */
    axios.post(`${url}/bios/v1/auth/forgotpassword/initiate`, message).then(
      () => {
        const successSvg = `
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M28.9999 57.4166C13.3058 57.4166 0.583252 44.694 0.583252 28.9999C0.583252 13.3058 13.3058 0.583252 28.9999 0.583252C44.694 0.583252 57.4166 13.3058 57.4166 28.9999C57.4166 44.694 44.694 57.4166 28.9999 57.4166ZM29 52.25C41.8406 52.25 52.25 41.8406 52.25 29C52.25 16.1594 41.8406 5.74999 29 5.74999C16.1594 5.74999 5.74999 16.1594 5.74999 29C5.74999 41.8406 16.1594 52.25 29 52.25ZM37.5065 19.4233L23.8332 33.0966L17.9099 27.1733L14.2565 30.8267L23.8332 40.4033L41.1599 23.0767L37.5065 19.4233Z" fill="#F1F1F1"/>
        ...
        message = `${successSvg} Email sent`;
        forgotPasswordErrorMessage.innerHTML = message;
        forgotPasswordInputField.value = '';
      },
      () => {
        forgotpasswordError('Sorry! Isima could not find your credentials');
      },
    );
  }
  ...
  function forgotpasswordError(message) {
    const errorSvg = `
    <svg  class="esl-forgot-password-error-svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="esl-container">
    <div class="esl-auth-left-container" id="goToSigninButton">
      <div class="esl-left-form">
          ...
          <input placeholder="Enter your work email..." id="esl-login-email" class="esl-input-field" />
          <span class="esl-input-field-group">
            <input placeholder="Enter password..." id="esl-password" type="password" class="esl-input-field" />
            <svg  id="esl-password-eye-invisible" viewBox="64 64 896 896" focusable="false" data-icon="eye" width="1em" height="1em" fill="#000"><path d="M942.2 486.2C847.4 286.5 704.1 186 512 186c-192.2 0-335.4 100.5-430.2 300.3a60.3 60.3 0 000 51.5C176.6 737.5 319.9 838 512 838c192.2 0 335.4-100.5 430.2-300.3 7.7-16.2 7.7-35 0-51.5zM512 766c-161.3 0-279.4-81.8-362.7-254C232.6 339.8 350.7 258 512 258c161.3 0 279.4 81.8 362.7 254C791.5 684.2 673.4 766 512 766zm-4-430c-97.2 0-176 78.8-176 176s78.8 176 176 176 176-78.8 176-176-78.8-176-176-176zm0 288c-61.9 0-112-50.1-112-112s50.1-112 112-112 112 50.1 112 112-50.1 112-112 112z"></path></svg>
            <svg id="esl-password-eye" class="visible" viewBox="64 64 896 896" focusable="false" class="" data-icon="eye-invisible" width="1em" height="1em" fill="#000"><path d="M942.2 486.2Q889.47 375.11 816.7 305l-50.88 50.88C807.31 395.53 843.45 447.4 874.7 512 791.5 684.2 673.4 766 512 766q-72.67 0-133.87-22.38L323 798.75Q408 838 512 838q288.3 0 430.2-300.3a60.29 60.29 0 000-51.5zm-63.57-320.64L836 122.88a8 8 0 00-11.32 0L715.31 232.2Q624.86 186 512 186q-288.3 0-430.2 300.3a60.3 60.3 0 000 51.5q56.69 119.4 136.5 191.41L112.48 835a8 8 0 000 11.31L155.17 889a8 8 0 0011.31 0l712.15-712.12a8 8 0 000-11.32zM149.3 512C232.6 339.8 350.7 258 512 258c54.54 0 104.13 9.36 149.12 28.39l-70.3 70.3a176 176 0 00-238.13 238.13l-83.42 83.42C223.1 637.49 183.3 582.28 149.3 512zm246.7 0a112.11 112.11 0 01146.2-106.69L401.31 546.2A112 112 0 01396 512z"></path><path d="M508 624c-3.46 0-6.87-.16-10.25-.47l-52.82 52.82a176.09 176.09 0 00227.42-227.42l-52.82 52.82c.31 3.38.47 6.79.47 10.25a111.94 111.94 0 01-112 112z"></path></svg>
          </span>
          <div style='width:100%;'>
          ...
          <div class="esl-login-bottom-content">
            <button class="esl-signup-signin-button" id="esl-signin-button">
              <span class="esl-signup-signin-button-text">Log In</span>
              <svg class="esl-solid-lines" width="27" height="1" viewBox="0 0 27 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="0.19165" y1="0.5" x2="26.1917" y2="0.5" stroke="white" />
              </svg>
            </button>
...
<!--                <h2 class="esl-form-header">Sign Up</h2>-->
                <div class="mobile-app-wrapper">
                  ...
                  <div class="coming-soon-tooltip">
                    ...
                    <img class="disabled" src="http://bios.isima.io/android-app.png" />
                  </div>
                  <!-- </a> -->
                  <div class="coming-soon-tooltip">
                    <div class="tooltiptext">Coming soon</div>
                    <img class="disabled" src="http://bios.isima.io/iphone-app.png" />
                  </div>
                </div>
...
<!--            </div>-->
            <div class="esl-signup-bottom-content">
              ...
              <button class="esl-signup-signin-button" id="esl-signup-button">
                <span class="esl-signup-signin-button-text">Sign Up</span>
                <svg style="margin-left: 10px" width="27" height="1" viewBox="0 0 27 1" xmlns="http://www.w3.org/2000/svg">
                  <line x1="0.19165" y1="0.5" x2="26.1917" y2="0.5" stroke="white" />
                </svg>
              </button>
            </div>
