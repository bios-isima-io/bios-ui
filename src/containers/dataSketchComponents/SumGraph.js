...
const SumGraph = ({ data, dataKey, isItTimestampLag }) => {
  const [width, height] = useWindowSize();

  if (!data.hasOwnProperty(dataKey) || width === 0 || height === 0) {
    return null;
  }
