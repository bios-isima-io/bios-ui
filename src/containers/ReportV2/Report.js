  ...
  useEffect(() => {
    if (
      ...
      loadReport({
        ...
        ...(sideCompareReportId && { sideCompareReportId }),
      });
    } else {
  ...
  const MainContent = () => {
    return (
      <div className="report-container">
        ...
        {!isMobile && <ReportInsights isMobile={isMobile}></ReportInsights>}
        <div className="report-detail-dropdown-wrapper">
          {isMobile && (
            <MobileDropdown
              showSection={showGraphSection}
              setShowSection={setShowGraphSection}
              textContent="Chart"
            />
          )}
          {showGraphSection && (
...
Report.propTypes = {
  ...
  sideCompareReportId: PropTypes.string,
};
