...
export const getMapXChartPlotDataLevel1 = ({
  ...
  if (selectedMetrics?.[0]?.type === 'derived') {
    ...
    return mapChartPlot({
      ...
      data: data,
      cyclicalData: showCyclicalData ? cyclicalDataResp : null,
      topology: worldTopo,
  ...
  return mapChartPlot({
    ...
    cyclicalData: showCyclicalData
      ? getDataLevel1SimpleMetric(cyclicalData)
      : null,
    topology: worldTopo,
    name: getName({ selectedMetrics }),
    cyclicalComparisonOn,
...
export const getMapXChartPlotDataLevel2 = ({
  ...
  return mapChartPlot({
    ...
    cyclicalData: showCyclicalData
      ? getDataLevel2SimpleMetric(cyclicalData)
      : null,
    topology,
    name: getName({ selectedMetrics }),
    cyclicalComparisonOn,
