...
import { metricsActions } from '../AdvanceSettings/Metrics/reducers';
import {
  getSimpleMetricModifier,
  getDerivedMetricModifier,
} from '../AdvanceSettings/Metrics/AddMetric/Type/getMetricModifier';
...
export default connect(mapStateToProps, mapDispatchToProps)(ReportInit);
