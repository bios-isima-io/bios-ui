...
const TopDisableInfo = ({ axis }) => {
  return (
    <Tooltip
      title={`Enable split-by ${axis} axis to use Top-N`}
...
function DataGranularity({
  ...
  return (
    <div className="report-data-granularity">
      <div className="data-granularity-header">
        Top N<Colon />
      </div>
      <div className="data-granularity-y-axis">
        <div className="text label">Y - Axis</div>
        ...
        {!shouldAllowTopY && (
          <div className="top-disable-container">
            <TopDisableInfo axis="Y"></TopDisableInfo>
          </div>
        )}
      </div>

      <div className="data-granularity-x-axis">
        <div className="text label">X - Axis</div>
        <div className="text value">Show Top</div>
        <div>
          <Select
        ...
        {!shouldAllowTopX && (
          <div className="top-disable-container">
            <TopDisableInfo axis="X"></TopDisableInfo>
          </div>
        )}
      </div>
    </div>
