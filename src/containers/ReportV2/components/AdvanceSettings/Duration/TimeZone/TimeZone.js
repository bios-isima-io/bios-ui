...
import { timeZoneActions } from './reducers';
import moment from 'moment-timezone';
import './../../../../styles.scss';
import './styles.scss';
const { Option } = Select;

const { setTimeZone } = timeZoneActions;

function TimeZone({ setTimeZone, timezone, userClickEvent, history }) {
  const { timeZones, offsetTimeZones } = getTimeZones();
  ...
  return (
    <div className="timezone-container">
      ...
      <Select
        ...
        defaultValue={timezone === '' ? moment.tz.guess() : timezone}
        onChange={(timezone) => {
          setTimeZone({ timezone });
          userClickEvent({
            history,
            eventLabel: `Time > Timezone ${timezone}`,
