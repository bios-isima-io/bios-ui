...
const initState = {
  ...
  cyclicalComparisonCustom: false, //TODO : Remove this one
...
export default function reducer(state = initState, action) {
  switch (action.type) {
    case SET_CC:
      return {
        ...state,
        cyclicalComparisonOn: action.payload.cyclicalComparisonOn,
      };

    case SET_CC_DISABLED:
      return {
        ...state,
        ...action.payload,
      };
    ...
    case SET_CC_CUSTOM:
      return {
        ...
        cyclicalComparisonStart: action.payload.cyclicalComparisonStart,
        cyclicalDelta: action.payload.cyclicalDelta,
      };
